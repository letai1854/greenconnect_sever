...
/**
 * Request DTO để lọc danh sách khách hàng (CUSTOMER role) với các tiêu chí nâng cao.
...
public class FilterCustomersRequest {
     ...
     * <p>Ví dụ: "Nguyễn" sẽ tìm trong fullName, email, phoneNumber có chứa "nguyễn"</p>
     */
    String searchField;
