...
/**
 * Request DTO để lấy danh sách users không phải CUSTOMER role.
 * <p>Admin sử dụng endpoint này để lấy danh sách tất cả staff (ORDER_MANAGER, PRODUCT_MANAGER, etc.)</p>
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class GetNonCustomerUsersRequest {
